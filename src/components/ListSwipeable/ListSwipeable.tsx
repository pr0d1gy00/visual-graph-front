						...
						>
							...
							>
								<div className={styles.sectionInfoContainer}>
									<Image className={styles.iconSectionList} width={'200'} height={'200'} src='/images-Photoroom.png' alt="icon Title"/>
									<h3>Titulo: {section.title}</h3>
								</div>
								<div	className={styles.sectionInfoContainer}>
									<Image className={styles.iconSectionList} width={'200'} height={'200'} src='/2800039-Photoroom.png' alt="icon Description"/>
